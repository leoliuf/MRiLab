...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.6\textwidth]{Pictures/FunctionToolboxes.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.08\textwidth]{Pictures/BatchSimPanelIcon.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1\textwidth]{Pictures/BatchSim.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.9\textwidth]{Pictures/TwoPulses.eps}
...
\begin{itemize}
	...
	\item Time Clips : Two editable boxes for defining time range
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.9\textwidth]{Pictures/MatlabSpiral.eps}
...
Notice that the two-pool MT model needs to satisfy chemical equilibrium described as $Rho_{f} \times K_{fb} = Rho_{b} \times K_{bf}$. After making VObj, then save the `VObj' structure as a MAT file. \textbf{Note that the Bloch-equation kernel is executed when the value of any sequence line updates. The time point at which update occurs is referred to as execution point.} To accurately model MT exchange during scan, the user needs to create execution points on the entire RF sequence line. A typical method is to insert a long RF pulse with zero amplitude at the empty portion of the RF sequence line. The interested users are referred to PSD\_SPGR3DMT for more information.

\item Make Virtual Object with Multiple Exchanging (ME) Water Pools Properties\\
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.4\textwidth]{Pictures/GeneralizedExchangeModel.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.08\textwidth]{Pictures/PhantomDesignPanelIcon.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1\textwidth]{Pictures/PhantomDesignGUI.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.3\textwidth]{Pictures/FieldDisplayButton.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.08\textwidth]{Pictures/SARWatcherPanelIcon.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/SARWatcher.eps}
...
, IEEE Trans. Med. Imag., \textbf{10}, (1991), 473-478.
...
, IEEE Trans. Med. Imag., \textbf{18}, (1999), 385-392.
...
, IEEE Trans. Med. Imag., \textbf{24}, (2005), 799-808.

\bibitem {Glover2005} \textsc{G.H. Glover}:\
\textit{Simple Analytic Spiral \textit{k}-space Algorithm}
...
\bibitem {Liu2016} \textsc{F. Liu, J.V. Velikina, W.F. Block, R. Kijowski and A.A. Samsonov}:\
\textit{Fast Realistic MRI Simulations Based on Generalized Multi-Pool Exchange Tissue Model}
, IEEE Trans. Med. Imag., doi: 10.1109/TMI.2016.2620961, 2016.

\bibitem {Collins2001} \textsc{C.M. Collins and M.B. Smith}:\
...
\bibitem {Cao2014} \textsc{Z. Cao, S. Oh, C.T. Sica, J.M. McGarrity, T. Horan, W. Luo and C.M. Collins}:\
...
\bibitem {Carluccio2013} \textsc{G. Carluccio, D. Erricolo, S. Oh and C.M. Collins}:\
